...
TEXTS = {
    "ar": {
        ...
        "payment_instructions": (
            ...
            "👆 اضغط مطولاً على العنوان أعلاه لتحديده ونسخه\n\n"
            "🔸 USDT (BEP20):\n<code>{bsc_wallet}</code>\n"
            "👆 اضغط مطولاً على العنوان أعلاه لتحديده ونسخه\n\n"
            "🔸 تحويل داخلي عبر Binance UID:\n<code>{binance_uid}</code>\n"
            "👆 اضغط مطولاً على الرقم أعلاه لتحديده ونسخه\n\n"
    ...
    "en": {
        ...
        "payment_instructions": (
            ...
            "🔸 USDT (TRC20):\n<code>{trc20_wallet}</code>\n"
            "👆 Press and hold the address above to select and copy it\n\n"
            "🔸 USDT (BEP20):\n<code>{bsc_wallet}</code>\n"
            "👆 Press and hold the address above to select and copy it\n\n"
            "🔸 Internal Binance transfer (UID):\n<code>{binance_uid}</code>\n"
            "👆 Press and hold the number above to select and copy it\n\n"
